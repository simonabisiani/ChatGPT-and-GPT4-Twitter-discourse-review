...
prop_topic_df <- gammaDF |>
  ...
  rename(
    "Business reaction" = 1,
    "Interactions with the tool" = 2,
    "Usage for content creation" = 3,
    "Technology behind ChatGPT" = 4,
    "Human-ChatGPT labour/skill relationship" = 5,
    "Human reaction" = 6,
    "Negative aspects of the tool" = 7,
    "Usage in job seeking" = 8,
    "Usage in programming" = 9,
    "Education" = 10,
    "Business training initiatives" = 11,
    "Job implications" = 12,
    "Teams / Projects" = 13,
    "Political/ethical challenges" = 14
  ) |>
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# TOPICS OVER TIME (we really don't plot anything from here since we consider the retweet readjusted dataset)
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
topic_abs_no_retweets <- ggplot(topic_proportion_per_month, aes(x = date, y = tot_week_topic, fill = name)) +
...
# Save the plot as a PNG file
png(
  "topic_over_time_abs_no_retweets.png",
  width = 6,
  height = 6,
  units = "in",
  res = 300
)
print(topic_abs_no_retweets)
dev.off()
